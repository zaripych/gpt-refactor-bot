...
export async function languageServiceReferences(project: Project, args: Args) {
    ...
    const sourceFile = args.initialFilePath
    ...
    for (const reference of referencedSymbols) {
        ...
        for (const ref of refs) {
            ...
            if (
                ...
                !args.includeFilePaths.includes(refSourceFile.getFilePath())
            ) {
                continue;
            }
